...
export const PROCESS = [
  {
    ...
    description:
      "Add properties and units once — everything stays structured and easy to manage.",
    icon: Building2,
  },
  {
    title: "Handle Tenants with Ease",
    description:
      "Keep track of tenants, leases, and communication in one place without the chaos.",
    icon: Users,
  },
  {
    title: "Stay on Top of Payments",
    description:
      "Collect rent, track payments, and monitor performance with full visibility.",
    icon: CreditCardIcon,
  },
] as const;
